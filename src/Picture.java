...
public class Picture extends SimplePicture 
{
  ...
  {
    Picture flower1 = new Picture("pie.jpg");
    Picture flower2 = new Picture("cutpie.jpg");
 ...
 public void mirrorVerticalRightToLeft()
 {
     ...
     Pixel leftPixel=null;
     Pixel rightPixel=null;
     int width=pixles[0].length;
     for(int row=0;row<pixles.length; row++)
     for(int col=0; col<width/2; col++){
         leftPixel=pixles[row][col];
         rightPixel=pixles[row][width-1-col];
  ...
  public void mirrorGull()
 {
  ...
  {
    Picture tester = new Picture("Map_files.jpg");
